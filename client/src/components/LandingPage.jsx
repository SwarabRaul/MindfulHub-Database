        ...
        <div className="landing_page_container">
            <section className="landing_section">
                ...
                <p>
                    ...
                    mental health. Join our community to share your thoughts, connect
                    with others, and explore helpful resources.
                </p>
            </section>
            ...
            <section className="landing_section">
                ...
                <div className="feature_item">
                    ...
                    <p>Share your experiences through blogs and engage in discussions.</p>
                </div>
                <div className="feature_item">
                    <h3>2. Live Chat</h3>
                    <p>Connect with others in real-time through our live chat feature.</p>
                </div>
                <div className="feature_item">
